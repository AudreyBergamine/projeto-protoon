    ...
    public void run(String... args) throws Exception {
      ...
      //  Departamento dep3 = new Departamento(null, "Finanças", "Aldo", "aldo@gmail.com", "1234", end3);
        ...
        Protocolo prot1 = new Protocolo(null, sec1, mun1, end2, "Assunto do protocolo", new Date(),
                "Descrição do protocolo", Status.CIENCIA, 100.0);


        Protocolo prot2 = new Protocolo(null, sec2, mun2, end3, "Outro assunto", new Date(), "Outra descrição", Status.EM_ANDAMENTO,
                150.0);

        Protocolo prot3 = new Protocolo(null, sec2, mun2, end3, "Teste", new Date(), "teste", Status.CONCLUIDO, 150.0);
